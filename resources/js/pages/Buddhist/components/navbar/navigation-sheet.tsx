        ...
        <div className="text-base space-y-4">
            ...
            <ul className="mt-2 space-y-3 ml-1 pl-4 border-l">
              {foods.map((foodItem) => (
                <li key={foodItem.title}>
                  <Link href={foodItem.href} className="flex items-center gap-2 hover:underline hover:text-primary text-black">
                    {foodItem.title}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="mt-2 space-y-3 ml-1 pl-4 border-l">
              {academic.map((item) => (
                <li key={item.title}>
                  <Link href={item.href} className="flex items-center gap-2 hover:underline hover:text-primary text-black">
                    {item.title}
                  </Link>
                </li>
              ))}
