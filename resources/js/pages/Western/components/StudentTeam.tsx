      ...
      {gradeLevelLeaders.map((category, index) => (
        <div key={index} className="mb-16">
          ...
          <p className="relative inline-block text-3xl font-bold text-primary 
                        ...
                        after:rounded-full after:bg-primary after:content-[''] md:text-5xl">
            {category.title}
          </p>

          {/* Category Description */}
          <div
            className="mt-4 text-base sm:text-lg whitespace-pre-line"
            dangerouslySetInnerHTML={{ __html: category.short_description }}
          />

          {/* Members Grid */}
          <div className="mt-10 flex flex-col justify-center px-6 lg:px-0">
              ...
              {category.children.map((member) => (
                <div key={member.id}>
                  <img
                    ...
                    alt={member.title}
                    className="aspect-square md;w-56 bg-primary object-cover"
                  />
