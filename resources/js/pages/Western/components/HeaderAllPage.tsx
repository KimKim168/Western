...
const HeaderAllPage = ({ data }: { data: any }) => {
    ...
    return (
        <div className="relative mx-auto flex flex-col pt-0 sm:pt-0">
            {/* Hero Image */}
            {data.images?.[0]?.image ? (
                <div className="relative w-full overflow-hidden">
                    <img
                        ...
                        alt={data.title}
                        className="aspect-[16/6] w-full object-cover md:aspect-[16/4]"
                    />
                </div>
            ) : (
            ...
            <div className="absolute inset-x-0 bottom-0 z-10 bg-primary/70">
                <div className="section-container py-4 sm:py-6 md:py-8">
                    <h3 className="text-xl font-bold tracking-tight text-white sm:text-3xl md:text-[55px]">
