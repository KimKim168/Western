        ...
        <div>
            <form onSubmit={onSubmit} className="form w-full p-0">
                <div className="space-y-6">
                    <FormField
                        className="mt-2 w-full rounded-none border-primary text-[15px] dark:border-primary"
                        required
                        id="name"
                        name="name"
                        label="Name"
                ...
                <Button
                    className="mt-6 flex w-[200px] items-center justify-between gap-2 rounded-none p-6 text-xl duration-300 hover:-translate-y-2"
                    size="lg"
                    disabled={processing}
                >
                    {processing && <Spinner />}
