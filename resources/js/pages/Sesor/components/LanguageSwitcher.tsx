...
export function LanguageSwitcher() {
    ...
    return (
        ...
        >
            <SelectTrigger className="text-base items-center font-semibold justify-center text-white px-0 border-none shadow-none [&>svg]:text-white [&_svg]:w-4 [&_svg]:h-0 gap-1">
